...
public final class StringUtils {
   ...
   *
   * @param filename The filename
   * @param withoutCompressedExtension true if the compression extension must be removed
   * @return the basename of the file
   */
  public static String basename(final String filename, final boolean withoutCompressedExtension) {
   ...
   */
  public static String extensionWithoutCompressionExtension(final String filename) {
   ...
   *
   * @param filename The filename
   * @return the compression extension or an empty string if there is no compression extension
   */
   ...
   */
  public static List<String> fastSplit(final String s, final List<String> list) {
   ...
   * @return the array with the new values
   */
  public static String[] fastSplit(
      final String s, final String[] array, final boolean allowEmptyFields) {
  ...
  /**
   * Get the content of a line without the first field. Tabulation is the separator
   *
   ...
   */
  public static String removeCompressedExtensionFromFilename(final String filename) {
   ...
   * @return an array without the first element of the input array
   */
  public static String[] arrayWithoutFirstsElement(
      final String[] array, final int elementsToRemove) {
   ...
   * @return true if the String starts with one of the prefix of a list in an array
   */
   ...
   * @return the content type of an empty string if the content type was not found
   */
  public static String getCommonContentTypeFromExtension(final String extension) {
  ...
  public static String replacePrefix(
      final String s, final String oldPrefix, final String newPrefix) {
   ...
   */
  public static List<String> deserializeStringArray(final String serializedString) {
  ...
  public static Iterable<String> splitStringIterator(final String s, final int length) {
    ...
    return new IterableString() {
      ...
      public String next() {
        ...
        final int endPos = (this.pos + length) > this.len ? this.len : this.pos + length;
   ...
   *
   * @param s the string
   * @return a string with double quotes at the beginning and at the end of the string or null if s
   *     is null
   */
   ...
   *
   * @param s the string.
   * @return a string without double quote at the beginning and at the end of the string or null if
   *     s is null
   */
  ...
  public static String md5DigestToString(final MessageDigest md5Digest) {
    ...
    if (!"MD5".equals(md5Digest.getAlgorithm())) {
      throw new IllegalArgumentException(
          "the md argument must be a MD5 MessageDigest but found: " + md5Digest.getAlgorithm());
    }
