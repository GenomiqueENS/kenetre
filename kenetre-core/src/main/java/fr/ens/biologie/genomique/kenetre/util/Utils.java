...
/**
 * This class contains some useful methods about collection, hashcode computation or precondition
 * checking.
 *
 * @since 1.0
...
public class Utils {
   ...
   * @return an unmodifiableSet with the values of the array or null if the array is null
   */
